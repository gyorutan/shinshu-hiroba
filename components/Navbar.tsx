...
import {LogIn, LogOut, Menu, UserRound, UserRoundCog, UserRoundPlus} from "lucide-react";
...
const Navbar = () => {
    ...
    return (
        <>
            <div
                className="border-b shadow-sm fixed flex justify-between items-center top-0 w-full max-w-[768px] min-w-[375px] m-auto bg-blue-500 text-white py-2 px-5">
